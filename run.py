...
# path_process = 'data/ripeness.xlsx'
path_process = 'data/data_sawit1.xlsx'
# path_testing = 'data/F1S1depan_diam.xlsx'
# path_testing = 'data/data_sawit_testing.xlsx'
path_testing = 'data/matang1.xlsx'
...
# connect to arduino to give command to stepper motor
data = serial.Serial('/dev/ttyACM0',9600, timeout=1) 
# time to adjust with arduino
time.sleep(2)
# data will be displayed in LCD and ended by enter
status = data.write( str.encode(outcome['index'])) 
